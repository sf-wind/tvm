...
fc_1_W = relay.var("fc_1_W", shape=(fc_dims, rnn_dims, ), dtype=dtype)
fc_1_B = relay.var("fc_1_B",
                   shape=(fc_dims,),
                   dtype=dtype)

relu1_o = relay.nn.relu(relay.nn.bias_add(relay.nn.dense(gru2_add1_o, fc_1_W), fc_1_B))

fc_3_W = relay.var("fc_3_W", shape=(n_classes, fc_dims), dtype=dtype)
fc_3_B = relay.var("fc_3_B", shape=(n_classes,), dtype=dtype)
fc_3_o = relay.nn.bias_add(relay.nn.dense(relu1_o, fc_3_W), fc_3_B)
...
log_filename = "synthesis_autotvm_skl_asdf.log"
def tune():
    global func
