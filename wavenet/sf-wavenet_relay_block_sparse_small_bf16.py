...
context = "llvm -mcpu=skylake-avx512 -target=x86_64-linux-gnu"
...
inputs = collections.OrderedDict(
    [(
        param.name_hint,
        tvm.ndarray.array(np.zeros(param.type_annotation.concrete_shape).astype("float32"))
